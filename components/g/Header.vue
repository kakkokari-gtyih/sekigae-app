...
<template>
    <header class="h-[3.65rem] p-3 bg-white border-b dark:border-slate-400 fixed top-0 left-0 w-full z-10">
        <div class="mx-auto max-w-screen-xl md:px-4 h-full flex items-center">
            ...
            <div class="ml-auto hidden md:flex items-center h-full space-x-3">
                ...
                <UButton color="gray" variant="ghost" square target="_blank" to="https://github.com/kakkokari-gtyih/sekigae-app">
                ...
                <a class="flex items-center bg-[#93251f] text-white hover:opacity-80 tonko-hp px-3 selection:bg-white selection:text-primary-500" target="_blank" href="https://tonko.ed.jp">
